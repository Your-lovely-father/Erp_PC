<template>
    <div class="reportAdd" v-show="seeisIntention">
        <div class="add_box">
            <div class="com">
                <div class="poor">
                    <div class="poor_text">
...
<script>
    ...
    export default {
        ...
        methods: {
            onPage() {
                this.$store.commit('isIntention', true);
                this.$store.commit('isSeeIntention', false);
            },
            cancel() {
                this.onPage()
            },
        ...
        computed: {
            seeisIntention() {
                return this.$store.state.intention.seeisIntention
            },
            detailObj() {
