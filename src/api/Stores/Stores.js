...
export default{
    ...
    //修改
    storesUpd(id,storefront_name,province_id,city_id,area_id){
        return Axios.post('/erp/storefront_edit',{ id:id, storefront_name:storefront_name,  province_id:province_id, city_id:city_id,area_id:area_id})
    }
}
